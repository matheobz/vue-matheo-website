...
<div class="container">
  <div class="navbar">
    ...
    <div class="arrow-container">
      <a onclick="document.getElementById('accordionSection').scrollIntoView({ behavior: 'smooth' });">
          <div class="arrow"></div>
      </a>
    </div>
    </div>
...
.button:hover {
  background-color: rgba(255, 255, 255, .4);/* Couleur de fond du bouton au survol */
